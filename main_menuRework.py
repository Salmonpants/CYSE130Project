...
def _handle_menu_escape(state: dict) -> None:
    """Called when the player types 'menu' mid-game. Confirms, saves, returns."""
    ...
    if answer == "y":
        ...
        # Player changed their mind — re-raise so the outer except can ignore it
        raise MenuRequested()
